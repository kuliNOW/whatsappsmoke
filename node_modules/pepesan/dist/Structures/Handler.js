    ...
    getReturnValue() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (matchRoute.type) {
                ...
                case 'menu':
                    if (this.menu) {
                        text = (_a = this._menus) === null || _a === void 0 ? void 0 : _a[this.menu].value;
                    }
                    break;
                default:
                    text = this.text;
            ...
            let requestParams = (_b = (0, StringExtractor_1.default)(matchRoute.path, { ignoreCase: true })(text)) !== null && _b !== void 0 ? _b : {};
            if (Array.isArray(matchRoute === null || matchRoute === void 0 ? void 0 : matchRoute.callback)) {
                ...
                requestParams = (_c = callbackParams.map((param) => requestParams[param])) !== null && _c !== void 0 ? _c : [];
                ...
                const callbackParams = (0, Utils_1.getParamsName)(callback);
                callbackParams.shift();
                requestParams = (_d = callbackParams.map((param) => requestParams[param])) !== null && _d !== void 0 ? _d : [];
