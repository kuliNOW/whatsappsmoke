...
class Pepesan {
    constructor(router, config = {}) {
        ...
        this.serverConfig = Object.assign(Object.assign({}, config.server), { port: (_r = (_q = config.server) === null || _q === void 0 ? void 0 : _q.port) !== null && _r !== void 0 ? _r : 3000, prefixPath: (_t = (_s = config.server) === null || _s === void 0 ? void 0 : _s.prefixPath) !== null && _t !== void 0 ? _t : '/api' });
        this.models = config.models;
        config.stateType = (_u = config.stateType) !== null && _u !== void 0 ? _u : 'db';
        config.statePath = (_v = config.statePath) !== null && _v !== void 0 ? _v : './state';
        config.statePrefixLength = (_w = config.statePrefixLength) !== null && _w !== void 0 ? _w : 9;
        config.readBeforeReply = (_x = config.readBeforeReply) !== null && _x !== void 0 ? _x : true;
        config.typingBeforeReply = (_y = config.typingBeforeReply) !== null && _y !== void 0 ? _y : false;
        config.reusableMenu = (_z = config.reusableMenu) !== null && _z !== void 0 ? _z : true;
